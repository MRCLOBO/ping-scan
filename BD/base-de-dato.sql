...
CREATE TABLE reportes (
  ...
  PRIMARY KEY(id_reportes, usuarios_id_usuarios, locales_id_locales, usuarios_usuario, locales_ip3),
  INDEX reportes_FKIndex1(usuarios_id_usuarios, usuarios_usuario),
