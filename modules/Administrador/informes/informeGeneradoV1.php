...
foreach ($dispositivosInfo as &$dispositivo) {
    foreach ($data['dispositivos'] as $estadoDispositivo) {
        if ($dispositivo['id_dispositivo'] == $estadoDispositivo['id']) {
...
$pdf = new PDF('P', 'cm', 'letter', $pedirLocal, $dispositivosInfo);
...
$rutaCarpeta = $_SERVER['DOCUMENT_ROOT'].'/ping-scan/modules/Administrador/informes/informes/';
...
$urlArchivo = 'http://localhost/ping-scan/modules/Administrador/informes/informes/Informe_Dispositivos.pdf';
