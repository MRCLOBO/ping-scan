...
<?php if($condicionTipoAuxiliar):?> <!-- inicio de mostrar tipos de dispositivos -->
            ...
            <div class="col-12 col-lg-6 " title="Selecciona este tipo de dispositivo"><!-- div de cada card del local -->
                ...
                <a class="btn btn-success" href="?mostrar_detalles=<?php echo htmlspecialchars($row['id_tipo_dispositivo'])?>" title="Muestra más informacion sobre este tipo de dispositivo">Más Detalles</a>
                </div>
            ...
            <a href="?editar_tipo" id="editar-tipo" title="Edita la informacion de un tipo de dispositivo">
            <img src="/ping-scan/public/media/imagenes/editar.png" alt="Editar Tipo"/>
            </a>
            <a href="?eliminar_tipo" id="eliminar-tipo" title="Elimina un tipo de dispositivo">
    ...
    <?php endif; ?>
            ...
            <a class="btn bg-danger text-light boton-atras" href="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php">X</a>
                <h2 class="bg-success">Añadir tipo de dispositivo</h2>
                ...
                <button type="submit" class="btn btn-success mb-3">Añadir tipo de dispositivo</button>
                </form>
            ...
            <div class="formulario-añadir-dispositivo">
            <a class="btn bg-danger text-light boton-atras" href="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php">X</a>
                <h2 class="bg-success">Editar tipo de dispositivos</h2>
                ...
                <button type="submit" class="btn btn-success mb-3">Editar tipo de dispositivo</button>
                </form>
            ...
            <?php if($eliminarTipo): ?><!-- inicio de eliminar dispositivo -->
                <div class="editar-fondo">
            <div class="formulario-añadir-dispositivo">
            <a class="btn bg-dark text-light boton-atras" href="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php">X</a>
        ...
        $equipoAdvertencia = htmlspecialchars($_SESSION['error']['equipo']) ?><!-- INICIO DE NO EXISTE TIPO -->
                ...
                <div class="editar-fondo">
                    ...
                    <a class="btn-dark text-light boton-atras" href="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php">X</a>
                        ...
                        <a class="btn-danger" href="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php">Cancelar</a>
                        <form action= 
                        <?php if(isset($_SESSION['error']['origen'])  && $_SESSION['error']['origen'] == 'anadir'){ echo '/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php?añadir_tipo=1';} 
                       else if(isset($_SESSION['error']['origen']) && $_SESSION['error']['origen'] == "editar"){ echo '/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php?editar_tipo='.htmlspecialchars($_SESSION['error']['id']);}?>  
                        method="POST">
   ...
   <script>
    ...
    for(n=0;n<tamañoTabla;n++){
        ...
        document.getElementById(valorActual).addEventListener("click",() => {
            ...
            document.getElementsByClassName("card-dispositivo-seleccionado")[0].className="card-local card-local-tecnico card-dispositivo";
            }
