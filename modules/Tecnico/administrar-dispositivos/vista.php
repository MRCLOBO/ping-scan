    ...
    <?php if($_SESSION['error'] !== null && $_SESSION['error']['error'] == "no existe tipo"): 
        $ip2Advertencia = htmlspecialchars($_SESSION['error']['ip2']) ?><!-- INICIO DE NO EXISTE TIPO -->
                ...
                <div class="editar-fondo">
                    ...
                    <a class="btn-dark text-light boton-atras" href="/ping-scan/modules/Tecnico/administrar-dispositivos/vista.php">X</a>
                        ...
                        <a class="btn-danger" href="/ping-scan/modules/Tecnico/administrar-dispositivos/vista.php">Cancelar</a>
                        <form action=
                         <?php if(isset($_SESSION['error']['origen'])  && $_SESSION['error']['origen'] == 'anadir'){ echo '/ping-scan/modules/Tecnico/administrar-dispositivos/vista.php?añadir_dispositivo=1';} 
                        else if(isset($_SESSION['error']['id'])){ echo '/ping-scan/modules/Tecnico/administrar-dispositivos/vista.php?editar_dispositivo='.htmlspecialchars($_SESSION['error']['id']);}?>  
                        method="POST">
                        ...
                        <form action="/ping-scan/modules/Tecnico/tipo_dispositivo/vista.php?añadir_tipo=1" method="POST">
                            <input type="hidden" name="ip2_advertencia" value=<?php echo $_SESSION['error']['ip2'];?> />
                            <input type="hidden" name="advertencia" value="tipo dispositivo no encontrado" />
        ...
        $ip3Advertencia = htmlspecialchars($_SESSION['error']['ip3']) ?><!-- INICIO DE NO EXISTE TIPO -->
                ...
                <div class="editar-fondo">
                    ...
                    <a class="btn-dark text-light boton-atras" href="/ping-scan/modules/Tecnico/administrar-dispositivos/vista.php">X</a>
                        ...
                        <form action="/ping-scan/modules/Tecnico/gestionar_locales/vista.php?añadir_local=1" method="POST">
                            <input type="hidden" name="ip3_advertencia" value=<?php echo $_SESSION['error']['ip3'];?> />
                            <input type="hidden" name="advertencia" value="local no encontrado" />
